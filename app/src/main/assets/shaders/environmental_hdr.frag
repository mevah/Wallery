...
// WalleryActivity.updateSphericalHarmonicsCoefficients for more information.
...
vec3 Pbr_CalculateDiffuseEnvironmentalRadiance(const vec3 normal,
  ...
  // See WalleryActivity.updateSphericalHarmonicsCoefficients() for more
...
vec3 Pbr_CalculateEnvironmentalRadiance(
  ...
  // WalleryActivity.sphericalHarmonicsFactors.
  vec3 diffuseTerm =
