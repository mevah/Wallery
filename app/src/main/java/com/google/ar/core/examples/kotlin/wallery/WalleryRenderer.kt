 ...
 */
package com.google.ar.core.examples.kotlin.wallery
...
class WalleryRenderer(val activity: WalleryActivity) :
  SampleRender.Renderer, DefaultLifecycleObserver {
  companion object {
    val TAG = "WalleryDEBUG"
  ...
  var counter = 0
  val imageList = arrayOf("models/test0.png", "models/test1.png", "models/test2.png", "models/test3.png")
  ...
  override fun onSurfaceCreated(render: SampleRender) {
    ...
    try {
      ...
      virtualObjectMesh = Mesh.createFromAsset(render, "models/flat0.obj")
      virtualObjectShader =
        Shader.createFromAssets(
            render,
